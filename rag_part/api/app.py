...
def compute_embeddings(text):
    tokenizer = AutoTokenizer.from_pretrained("/Users/likuntai/Downloads/rag-from-scratch-main/api/model/tokenizer")
    model = AutoModel.from_pretrained("/Users/likuntai/Downloads/rag-from-scratch-main/api/model/embedding")
...
def main():
    ...
    vec_store = open_json('/Users/likuntai/Downloads/rag-from-scratch-main/api/vector_store.json')
    doc_store = open_json('/Users/likuntai/Downloads/rag-from-scratch-main/api/doc_store.json')
    ...
    llm = Llama(model_path="/Users/likuntai/Downloads/rag-from-scratch-main/api/mistral-7b-instruct-v0.2.Q3_K_L.gguf")
    response = llm(formatted_prompt, max_tokens=800, stop=["Q:"], echo=False, stream=False)
